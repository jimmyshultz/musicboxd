...
export const AppleSignInDebug: React.FC = () => {
  useEffect(() => {
    ...
    try {
      ...
      console.log(
        '🍎 [DEBUG] AppleSignInDebug: Module keys:',
        Object.keys(appleModule),
      );
      console.log(
        '🍎 [DEBUG] AppleSignInDebug: appleAuth type:',
        typeof appleModule.appleAuth,
      );
      console.log(
        '🍎 [DEBUG] AppleSignInDebug: AppleButton type:',
        typeof appleModule.AppleButton,
      );

      if (appleModule.appleAuth) {
        console.log(
          '🍎 [DEBUG] AppleSignInDebug: appleAuth methods:',
          Object.keys(appleModule.appleAuth),
        );
      }

      if (appleModule.AppleButton) {
        console.log(
          '🍎 [DEBUG] AppleSignInDebug: AppleButton properties:',
          Object.keys(appleModule.AppleButton),
        );
      }
    } catch (error) {
    ...
    try {
      ...
      console.log(
        '🍎 [DEBUG] AppleSignInDebug: Package.json dependency version:',
        appleDep,
      );
    } catch (error) {
      console.log(
        '🍎 [DEBUG] AppleSignInDebug: Could not read package.json:',
        error,
      );
    }
    ...
    try {
      ...
      console.log(
        '🍎 [DEBUG] AppleSignInDebug: Could not check filesystem:',
        error,
      );
    }
  }, []);
