-- ============================================================================
-- Migration: Consolidate Diary Entry Social Features
-- ============================================================================
-- This migration consolidates all diary entry social features:
...
-- 5. Creates triggers for maintaining counts (including soft deletes)
-- 6. Creates triggers for creating notifications
-- 7. Updates notifications.type constraint to include diary_like and diary_comment
-- 8. Fixes foreign key constraints to reference user_profiles
-- ============================================================================
...
-- ============================================================================
-- PART 3: Fix Foreign Key Constraints (Must reference user_profiles, not auth.users)
-- ============================================================================
...
-- ============================================================================
-- PART 4: Add Denormalized Counts to Diary Entries Table
-- ============================================================================
...
-- ============================================================================
-- PART 6: Trigger Functions for Maintaining Counts
-- ============================================================================
...
-- Function to update comments_count on diary_entries (handles soft deletes)
...
-- ============================================================================
-- PART 7: Create Triggers for Count Maintenance
-- ============================================================================
...
-- ============================================================================
-- PART 8: Trigger Functions for Notifications
-- ============================================================================
...
-- ============================================================================
-- PART 9: Create Triggers for Notifications
-- ============================================================================
...
-- ============================================================================
-- PART 10: Update Notifications Type Constraint
-- ============================================================================
...
-- ============================================================================
-- PART 11: Backfill Counts for Existing Diary Entries
-- ============================================================================
...
WHERE EXISTS (
    SELECT 1 FROM public.diary_entry_likes del WHERE del.entry_id = de.id
) OR likes_count = 0;

-- Backfill comments_count (only count non-deleted comments)
UPDATE public.diary_entries de
SET comments_count = (
    SELECT COUNT(*) 
...
WHERE EXISTS (
    SELECT 1 FROM public.diary_entry_comments dec 
    WHERE dec.entry_id = de.id AND dec.is_deleted = false
) OR comments_count = 0;
...
-- ✓ Foreign keys referencing user_profiles (not auth.users)
-- ✓ Denormalized counts on diary_entries table
-- ✓ Row Level Security policies
-- ✓ Triggers for maintaining counts (including soft delete handling)
